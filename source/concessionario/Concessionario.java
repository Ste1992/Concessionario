...
public class Concessionario {
	...
	public void personale() {		
		...
		impiegati.add(new Impiegati("Roberto", "Colera", "impiegato", 10.0));
		impiegati.add(new Impiegati("Davide", "Laspugna", "impiegato", 8.30));
		...
		addettiVendite.add(new AddettiVendite("Hugo", "Boh", "addetto vendite", 9.00, 3));
		System.out.println("\nAddetti vendite:");
